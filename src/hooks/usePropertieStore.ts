...
export const usePropertieStore = () => {
    ...
    const getPropertiesRooms = async () => {
        ...
        const { data } = await coffeApiLeandro.get('/rooms/properties/roomslist/');
    ...
    const postCreatePropertie = async (body: object) => {
        try {
            ...
            console.log(body)
            const { data } = await coffeApiLeandro.post(`/rooms/properties/`, body);
            console.log(data)
    ...
    const patchUpdatePropertie = async (id: number, body: object) => {
        try {
            ...
            console.log(body)
            const { data } = await coffeApiLeandro.patch(`/rooms/properties/${id}`, body);
            console.log(data)
